...
class LedgerEntry(Base, IdMixin, TimestampMixin, TenantOwnedMixin):
    ...
    advance_balance_snapshot: Mapped[Decimal | None] = mapped_column(Numeric(14, 2))
    commission_payable_snapshot: Mapped[Decimal | None] = mapped_column(Numeric(14, 2))
    net_settlement_snapshot: Mapped[Decimal | None] = mapped_column(Numeric(14, 2))
    source_receivable_snapshot: Mapped[Decimal | None] = mapped_column(Numeric(14, 2))
